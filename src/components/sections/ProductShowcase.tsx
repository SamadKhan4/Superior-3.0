        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <FadeUp className="lg:col-span-4 lg:col-start-9 lg:pt-6">
            <p className="text-[15px] leading-relaxed text-chalk/60 sm:text-[16px]">
              From structural reinforcement to advanced perimeter protection,
              explore engineered mesh and fencing systems manufactured for
          ...
          <div className="col-span-3">
            ...
            <ul className="mt-6 space-y-0">
              ...
              <li key={p.id} className="relative">
                  ...
                  type="button"
                  onClick={() => setActive(i)}
                  className={`flex w-full items-baseline gap-3 border-b border-metal/10 py-2.5 text-left transition-colors duration-200 ${
                  i === active ?
                  'text-chalk' :
