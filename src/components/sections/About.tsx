      ...
      <div
        ...
        <div className="lg:col-span-6 lg:pt-10">
          ...
          <div className="mt-10 max-w-xl space-y-6 text-[16px] leading-relaxed text-ink/70">
            <FadeUp>
              <p>
                Superior Weldmesh has been manufacturing engineered wire mesh and
                fencing solutions since 2013, serving requirements across
                infrastructure, construction, architecture, industrial and
                perimeter-security applications.
              </p>
            </FadeUp>
            <FadeUp delay={0.08}>
              <p>
                Our production is built around consistency: controlled wire
                specifications, repeatable weld integrity and finishing that holds
                up in the field. Most orders we take are not catalogue items —
                they are drawn from a project specification, engineered around an
                aperture, coating or panel size, and produced to that drawing.
              </p>
            </FadeUp>
            <FadeUp delay={0.14}>
              <p>
                That approach has built long-running relationships with
                contractors, exporters, architects and industrial buyers who need
                a mesh supplier that executes reliably rather than approximately.
              </p>
            </FadeUp>
          </div>
        ...
        <div className="relative lg:col-span-5 lg:col-start-8">
          ...
          <motion.ul
            ...
            style={reduce ? undefined : { y: labelY }}>
