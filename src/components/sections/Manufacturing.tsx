...
/** Grid whose intersections flash orange — the physical weld point as a UI motif. */
function WeldGrid() {
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          <FadeUp className="lg:col-span-5 lg:pt-8">
            <p className="text-[16px] leading-relaxed text-chalk/75 lg:text-[18px]">
              Every mesh is only as dependable as the consistency behind every
              weld. Our manufacturing approach focuses on dimensional accuracy,
              dependable materials, quality control and repeatable production.
            </p>
          </FadeUp>
        </div>
