...
type CursorMode = 'default' | 'view' | 'left' | 'right';

/** Desktop-only cursor. Disabled entirely on touch devices and under reduced motion. */
export function Cursor() {
  ...
  useEffect(() => {
    ...
    const move = (e: MouseEvent) => {
      ...
      setMode(holder?.dataset.cursor as CursorMode || 'default');
    };
